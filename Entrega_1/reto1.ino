...
const char MQTT_PUB_TOPIC1[] = "humedad/santa_marta/" HOSTNAME;
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC2[] = "temperatura/santa_marta/" HOSTNAME;
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC3[] = "luminosidad/santa_marta/" HOSTNAME;
...
void loop()
{
  ...
  if(!isnan(intencidad) ){
    //Publica en el tópico de la intensidad
